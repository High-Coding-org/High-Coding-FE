export const HomePageTexts = {
  title: ['나만의 키트로 만들어가는', '임베디드 스마트 팜'],
  subTitle: [
    '웹과 임베디드 기술이 만난 DIY 스마트팜',
    '복잡한 설치 없이,  누구나 쉽고 직관적으로 식물을 관리할 수 있습니다.',
    '스마트한 자동화 식물 관리,  직접 체험해 보세요!',
  ],
  part1_Text: ['처음 키우는 식물도', '어려움 없이'],
  part1_SubText: [
    '스마트팜으로 시작하세요.',
    '이제는 누구나 손쉽게',
    '식물 전문가처럼 키울 수 있습니다.',
  ],
  part2_Text: ['식물을 체계적으로', '관리해 보세요'],
  part2_SubText: [
    '식물 성장 일기 페이지에서',
    '식물의 상태를 간편하게 기록하고',
    '생장 패턴을 시각적으로 확인할 수 있어요.',
  ],
  part3_Text: ['어떤 식물을 키울지', '고민되시나요?'],
  part3_SubText: [
    'AI가 여러분의 환경을 분석하여',
    '키우기 적합한 식물을 추천해드립니다.',
  ],
  part4_Text: ['스마트팜 앱을 통해', '손쉬운 식물 관리까지'],
  part4_SubText: [
    '환경 데이터를 실시간으로 측정해요.',
    '원하는 날짜의 데이터를 차트로 확인해 보세요.',
    '식물 성장 추이를 확인할 수 있어요.',
  ],
  part5_Text: ['하이코딩만의', '특별한 기능들'],
  part5_SubText: [
    {
      title: '자동 급수 시스템',
      icon: 'Droplet',
  ...
  footer_Text: '지금 하이코딩과 함께 시작해 보세요.',
};
